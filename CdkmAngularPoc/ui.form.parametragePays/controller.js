...
.controller('uiFormParametragePaysController', ['$cookies','$rootScope','$scope',
                                        '$location',
                                        '$http',
   ...
   $scope.init = function() {
	...
	$scope.goToEditPays = function(){
		// $cookies.putObject('paysSelected', $scope.pays.customObject.demande);
		$cookies.putObject('paysSelected', $scope.pays);
